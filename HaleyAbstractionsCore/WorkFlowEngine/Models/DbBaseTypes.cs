...
namespace Haley.Models {
    public readonly struct DbArg {
        ...
        public DbArg(string name, object? value) {
            Name = name;
            Value = value;
        }
        ...
        public static implicit operator DbArg((string Name, object? Value) t) => new DbArg(t.Name, t.Value); //For implicit conversion without specifying 'new'
    }
